              ...
              <div class="mt-5 px-4">
                <div :class="mainText">
                  <ol style="list-style-type: decimal">
                    <li>本規約は，ユーザーとフルギキタイ運営者（以下、「運営者」といいます。）との間の本サービスの利用に関わる一切の関係に適用されるものとします。</li>
          ...
          <div class="my-10 px-16">
            <div class="d-flex flex-row mb-6">
              <v-sheet
                ...
                width="25"
              ></v-sheet>
              <div :class="subHeader">第2条（利用登録）</div>
            </div>
              <div class="mt-5 px-4">
                <div :class="mainText">
                  <ol style="list-style-type: decimal">
...
export default {
  computed: {
    mainContent () {
      if (this.$vuetify.breakpoint.xs) return 'main-content mt-2 mx-5'
