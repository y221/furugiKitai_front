...
export default {
  ...
  data() {
    return {
      terms:[
        '個人情報', '個人情報の収集方法', '個人情報を収集・利用する目的', '利用目的の変更', '個人情報の第三者提供', '個人情報の開示', '個人情報の訂正及び削除', '個人情報の利用停止等', 'プライバシーポリシーの変更', 'お問い合わせ窓口'
      ],
      textsList:[
        [
        ...
        [
          '運営者は、ユーザーが利用登録をする際に氏名、SNSアカウントなどの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を、運営者の提携先（情報提供元、広告主、広告配信先などを含みます。以下、「提携先」といいます。）などから収集することがあります。'          
        ],
        [
        ...
        [
          ...
          '運営者名：フルギキタイ運営チーム',
          'Eメールアドレス：furugi_kitai@gmail.com'
        ]
      ],
      numbersList:[
        [],[],
